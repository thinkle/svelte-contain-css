...
<TextLayout>
  ...
  <Code language="none"
    code={`npm install containcss-svelte`}
    />
  <p>Once you have that, you will need to make sure to import
    our styles somewhere in your project, such as at the top level,
    in order to define the CSS variables we depend on. You 
    can also select a theme or set of themes if you like.
  </p>
  <Code language="js"
    code={`
...
`}
  ...
  <p>Now you're ready to import and use our components
    anywhere you like in the project.
  </p>
  <Code language="html"
    code={`
<script>

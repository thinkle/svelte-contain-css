...
<CssVariableDemo variables={tooltipVars}>
  ...
  <p>
    Basic usage just involves wrapping an element and handing in tooltip text as
    a prop, like this:
  </p>
  <Code
  ...
  <p>
    The tooltip will automatically adjust positions. You can change the default
    positioning by handing in horizontal=left|right and vertical=top|bottom as
    props.
  </p>
  ...
  <p>
    If you want to include markup inside a tooltip instead of just text, you can
    use the alternate slot syntax, like this:
  </p>
  <Tooltip>

...
<Container>
  ...
  <TextLayout>
    <h2>Dialogs</h2>
    <p>
      We use the new HTML dialog element in our dialog components for simplicity
      sake.
    </p>
    <h3>Modal Dialogs</h3>
    <p>
      A modal dialog is <em>not</em> "light dismissable" but must be explicitly closed.
    </p>
    ...
    >
      <h3>Modal Dialog</h3>
      <p>
        A modal dialog will display centered over the content and block the rest
        of the page.
      </p>
    </Dialog>
    <Code
...
`}
    ...
    <p>
      A non-modal dialog looks like a dialog, but displays like any other block
      element.
    </p>
